export function readBitFromUInt8(byte, offset, length) {
...
export function readBitFromUInt16(byte, offset, length) {
    if (offset === void 0) { offset = 0; }
    if (length === void 0) { length = 1; }
...
export function readBitFromUInt32(byte, offset, length) {
    if (offset === void 0) { offset = 0; }
    if (length === void 0) { length = 1; }
